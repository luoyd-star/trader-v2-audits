# Trader-v2 Daily Health Check — 2026-09-26

_Generated at 2026-09-26 11:30:01 by `scripts/daily_health_check.py`._
...
- **com.bull.trader-v2**: state=`running` pid=`801` last_exit=`(never`
  - uptime/rss: `14-11:34:09 414048`
- **com.bull.trader-v2-dashboard**: state=`running` pid=`797` last_exit=`(never`
  - uptime/rss: `14-11:34:09   7968`

---

## News-agent Freshness

- **latest folder**: `2026-06-12_09-30-04` (age: 1775.1h)
- **STATE_UPDATE.md**: ✓
- **Trader_Handoff.json**: ✓
- **Memory_Pack.yaml**: ✓
⚠ Report is **1775.1h old** — news_agent may have stopped producing.
...
- **package_id**: `435`
- **generated_at**: `2026-09-05 09:45:43` (age: 505.7h, today's: **NO — STALE**)
