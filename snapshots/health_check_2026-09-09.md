# Trader-v2 Daily Health Check — 2026-09-09

_Generated at 2026-09-09 11:30:05 by `scripts/daily_health_check.py`._
...
- **com.bull.trader-v2**: state=`running` pid=`817` last_exit=`(never`
  - uptime/rss: `31-09:54:58 333376`
- **com.bull.trader-v2-dashboard**: state=`running` pid=`812` last_exit=`(never`
  - uptime/rss: `31-09:54:58   5984`

---

## News-agent Freshness

- **latest folder**: `2026-06-12_09-30-04` (age: 1367.1h)
- **STATE_UPDATE.md**: ✓
- **Trader_Handoff.json**: ✓
- **Memory_Pack.yaml**: ✓
⚠ Report is **1367.1h old** — news_agent may have stopped producing.
...
- **package_id**: `435`
- **generated_at**: `2026-09-05 09:45:43` (age: 97.7h, today's: **NO — STALE**)
