# Trader-v2 Daily Health Check — 2026-05-24

_Generated at 2026-05-24 11:30:00 by `scripts/daily_health_check.py`._
...
- **com.bull.trader-v2**: state=`running` pid=`1294` last_exit=`(never`
  - uptime/rss: `01-12:15:49  29200`
- **com.bull.trader-v2-dashboard**: state=`running` pid=`1292` last_exit=`(never`
  - uptime/rss: `01-12:15:49   9312`

---

## News-agent Freshness

- **latest folder**: `2026-05-23_19-46-17` (age: 15.7h)
- **STATE_UPDATE.md**: ✓
- **Trader_Handoff.json**: ✓
- **Memory_Pack.yaml**: ✓
...
- **package_id**: `11`
- **generated_at**: `2026-05-24 09:50:25` (age: 1.7h, today's: **YES**)
...
|---|---|---|---|---|---|---|---|
| A5_Contrarian | GEUSDT | LONG | 280.43 | $2000 | 135.6h / 120h | 113% | (legacy) |
| A7_PairsContrarian | TSMUSDT | LONG | 397.5 | $1409 | 76.3h / 120h | 64% | (legacy) |
| A5_Contrarian | METAUSDT | LONG | 596.53 | $2200 | 51.4h / 120h | 43% | (legacy) |
| A1_Momentum | NVDAUSDT | LONG | 221.5 | $2487 | 86.8h / 240h | 36% | (legacy) |
| A1_Momentum | ARMUSDT | LONG | 265.63 | $2500 | 56.6h / 240h | 24% | (legacy) |
| A5_Contrarian | XAUUSDT | LONG | 4515.49 | $1800 | 3.1h / 120h | 3% | 7 |

Total open: 6. Pre-Phase-2 legacy (no parent_thesis_id): 5.
...
| Category | Count |
|---|---|
| yfinance (benign noise) | 928 |
| Other ERROR | 356 |
| Python Traceback | 337 |
